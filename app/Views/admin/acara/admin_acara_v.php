        ...
        <tbody>
          ...
          <?php foreach ($dataAcara as $d) : ?>
            <tr>
              ...
              <td>
                <a href="" id="edit" data-id="<?= $d->id ?>" data-acara="<?= $d->acara ?>" data-judul="<?= $d->judul ?>" data-konten="<?= $d->konten ?>" data-harga="<?= $d->harga ?>" data-toggle="modal" data-target="#ubahData"><i class="fa fa-edit text-info mr-2"></i></a>
              ...
              <td><a href="<?= base_url('Acara/detail/' . $d->id) ?>" class="text-dark" target="_blank"><?= $d->acara ?></a></td>
              <td><?= $d->judul ?></td>
              <td><?= $d->konten ?></td>
              <td><?= $d->harga ?></td>
            </tr>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Ubah acara</h5>
