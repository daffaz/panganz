<section>
                    ...
                    <?php foreach ($dataTrending as $d) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('SangatRahasia/adminDeleteTrending/' . $d->id) ?>" onclick="return confirm('Yakin ingin menghapus artikel?')"><i class="fa fa-trash text-danger"></i></a>
                            </td>
                            <td><a href="<?= base_url('Artikel/detailTrending/' . $d->id) ?>" class="text-dark" target="_blank"><?= $d->judul ?></a></td>
                            <td><?= $d->organisasi ?></td>
                            <td><?= $d->nama ?></td>
                            <td><?= $d->tanggal ?></td>
                            <td><?= $d->berita . '... ' ?></td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="<?php echo base_url('SangatRahasia/adminTambahArtikelTrending') ?>" method="post">
    ...
    <div class="modal fade" id="tambahData" tabindex="-1" role="dialog" aria-labelledby="tambahData" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Tambah artikel trending</h5>
