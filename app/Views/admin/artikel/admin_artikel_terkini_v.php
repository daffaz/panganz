                ...
                <tbody>
                    ...
                    <?php foreach ($dataTerkini as $d) : ?>
                        <tr>
                            ...
                            <td><a href="<?= base_url('Artikel/detailTerkini/' . $d->id) ?>" class="text-dark" target="_blank"><?= $d->judul ?></a></td>
                            <td><?= $d->organisasi ?></td>
                            <td><?= $d->nama ?></td>
                            <td><?= $d->tanggal ?></td>
                            <td><?= $d->berita . '... ' ?></td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="<?php echo base_url('SangatRahasia/adminTambahArtikelTerkini') ?>" method="post">
